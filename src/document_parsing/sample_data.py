...
sample_text_payload_insertion_list = [{'doc_id': '6bd1667b-45b9-4b0b-a9d6-7ce4d7f25db2', 'chunk_id': '6bd1667b-chunk-1', 'raw_content': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK', 'meta_data': {'page_no.': 0, 'index_on_page': 1, 'content_type': 'title', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}}, {'doc_id': '6bd1667b-45b9-4b0b-a9d6-7ce4d7f25db2', 'chunk_id': '6bd1667b-chunk-2', 'raw_content': 'Zirui Guo, Xubin Ren, Lingrui Xu, Jiahao Zhang, Chao Huang*', 'meta_data': {'page_no.': 0, 'index_on_page': 2, 'content_type': 'text', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}}, {'doc_id': '6bd1667b-45b9-4b0b-a9d6-7ce4d7f25db2', 'chunk_id': '6bd1667b-chunk-3', 'raw_content': 'The University of Hong Kong', 'meta_data': {'page_no.': 0, 'index_on_page': 3, 'content_type': 'text', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}}, {'doc_id': '6bd1667b-45b9-4b0b-a9d6-7ce4d7f25db2', 'chunk_id': '6bd1667b-chunk-4', 'raw_content': 'zrguol01@hku.hk xubinrencs@gmail.com chaohuang75@gmail.com', 'meta_data': {'page_no.': 0, 'index_on_page': 4, 'content_type': 'text', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}}, {'doc_id': '6bd1667b-45b9-4b0b-a9d6-7ce4d7f25db2', 'chunk_id': '6bd1667b-chunk-5', 'raw_content': 'ABSTRACT', 'meta_data': {'page_no.': 0, 'index_on_page': 5, 'content_type': 'title', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}}, {'doc_id': '6bd1667b-45b9-4b0b-a9d6-7ce4d7f25db2', 'chunk_id': '6bd1667b-chunk-6', 'raw_content': 'Retrieval-Augmented Generation (RAG) has emerged as a fundamental paradigm for expanding Large Language Models beyond their static training limitations. However, a critical misalignment exists between current RAG capabilities and real-world information environments. Modern knowledge repositories are inherently multimodal, containing rich combinations of textual content, visual elements, structured tables, and mathematical expressions. Yet existing RAG frameworks are limited to textual content, creating fundamental gaps when processing multimodal documents. We present RAG-Anything, a unified framework that enables comprehensive knowledge retrieval across all modalities. Our approach reconceptualizes multimodal content as interconnected knowledge entities rather than isolated data types. The framework introduces dual-graph construction to capture both cross-modal relationships and textual semantics within a unified representation. We develop cross-modal hybrid retrieval that combines structural knowledge navigation with semantic matching. This enables effective reasoning over heterogeneous content where relevant evidence spans multiple modalities. RAG-Anything demonstrates superior performance on challenging multimodal benchmarks, achieving significant improvements over state-of-the-art methods. Performance gains become particularly pronounced on long documents where traditional approaches fail. Our framework establishes a new paradigm for multimodal knowledge access, eliminating the architectural fragmentation that constrains current systems. Our framework is open-sourced at: https://github.com/HKUDS/RAG-Anything.', 'meta_data': {'page_no.': 0, 'index_on_page': 6, 'content_type': 'text', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}}, {'doc_id': '6bd1667b-45b9-4b0b-a9d6-7ce4d7f25db2', 'chunk_id': '6bd1667b-chunk-7', 'raw_content': '1 INTRODUCTION', 'meta_data': {'page_no.': 0, 'index_on_page': 7, 'content_type': 'title', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}}, {'doc_id': '6bd1667b-45b9-4b0b-a9d6-7ce4d7f25db2', 'chunk_id': '6bd1667b-chunk-8', 'raw_content': 'Retrieval-Augmented Generation (RAG) has emerged as a fundamental paradigm for expanding the knowledge boundaries of Large Language Models (LLM) beyond their static training limitations Zhang et al. (2025). By enabling dynamic retrieval and incorporation of external knowledge during inference, RAG systems transform static language models into adaptive, knowledge-aware systems. This capability has proven essential for applications requiring up-to-date information, domain-specific knowledge, or factual grounding that extends beyond pre-training corpora.', 'meta_data': {'page_no.': 0, 'index_on_page': 8, 'content_type': 'text', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}}, {'doc_id': '6bd1667b-45b9-4b0b-a9d6-7ce4d7f25db2', 'chunk_id': '6bd1667b-chunk-9', 'raw_content': 'However, existing RAG frameworks focus exclusively on text-only knowledge while neglecting the rich multimodal information present in real-world documents. This limitation fundamentally misaligns with how information exists in authentic environments. Real-world knowledge repositories are inherently heterogeneous and multimodal Abootorabi et al. (2025). They contain rich combinations of textual content, visual elements, structured tables, and mathematical expressions across diverse document formats. This textual assumption forces existing RAG systems to either discard non-textual information entirely or flatten complex multimodal content into inadequate textual approximations.', 'meta_data': {'page_no.': 0, 'index_on_page': 9, 'content_type': 'text', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}}, {'doc_id': '6bd1667b-45b9-4b0b-a9d6-7ce4d7f25db2', 'chunk_id': '6bd1667b-chunk-10', 'raw_content': 'The consequences of this limitation become particularly severe in document-intensive domains where multimodal content carries essential meaning. Academic research, financial analysis, and technical documentation represent prime examples of knowledge-rich environments. These domains fundamentally depend on visual and structured information. Critical insights are often encoded exclusively in non-textual formats. Such formats resist meaningful conversion to plain text.', 'meta_data': {'page_no.': 0, 'index_on_page': 10, 'content_type': 'text', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}}, {'doc_id': '6bd1667b-45b9-4b0b-a9d6-7ce4d7f25db2', 'chunk_id': '6bd1667b-chunk-11', 'raw_content': 'The consequences of this limitation become particularly severe in knowledge-intensive domains where multimodal content carries essential meaning. Three representative scenarios illustrate the critical', 'meta_data': {'page_no.': 0, 'index_on_page': 11, 'content_type': 'text', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}}, {'doc_id': '6bd1667b-45b9-4b0b-a9d6-7ce4d7f25db2', 'chunk_id': '6bd1667b-chunk-12', 'raw_content': 'need for multimodal RAG capabilities. In Scientific Research, experimental results are primarily communicated through plots, diagrams, and statistical visualizations. These contain core discoveries that remain invisible to text-only systems. Financial Analysis relies heavily on market charts, correlation matrices, and performance tables. Investment insights are encoded in visual patterns rather than textual descriptions. Additionally, Medical Literature Analysis depends on radiological images, diagnostic charts, and clinical data tables. These contain life-critical information essential for accurate diagnosis and treatment decisions. Current RAG frameworks systematically exclude these vital knowledge sources across all three scenarios. This creates fundamental gaps that render them inadequate for real-world applications requiring comprehensive information understanding. Therefore, multimodal RAG emerges as a critical advancement. It is necessary to bridge these knowledge gaps and enable truly comprehensive intelligence across all modalities of human knowledge representation.', 'meta_data': {'page_no.': 1, 'index_on_page': 1, 'content_type': 'text', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}}]

sample_multi_model_payload_insertion_list = [{'doc_id': '5e17f2e1-1020-4682-8b76-175534156872', 'chunk_id': '5e17f2e1-chunk-1', 'raw_content': 'The table presents comparative statistics for two experimental datasets, DocBench and MMLongBench. Each dataset is described across five numerical attributes: number of documents, average number of pages per document, average number of tokens per document, number of document types, and number of questions. DocBench contains 229 documents, averaging 66 pages and 46,377 tokens per document, spanning 5 document types and totaling 1,102 questions. MMLongBench, by contrast, includes 135 documents averaging 47.5 pages and 21,214 tokens, covers 7 document types, and comprises 1,082 questions. The statistics highlight differences in scale, length, and diversity between the datasets.', 'meta_data': {'page_no.': 6, 'index_on_page': 2, 'content_type': 'table', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}}, {'doc_id': '5e17f2e1-1020-4682-8b76-175534156872', 'chunk_id': '5e17f2e1-chunk-2', 'raw_content': "The table presents accuracy percentages on the DocBench Dataset, comparing four methods (GPT-4o-mini, LightRAG, MMGraphRAG, and RAGAnything) across various document domains and question types. The domains include Academia, Finance, Government, Law, and News, while the types cover Text-only, Multimodal, and Unanswerable queries. Accuracy scores are shown for each method and category, with the highest value in each column highlighted most strongly and the second-highest less strongly. The final column reports the overall accuracy for each method. RAGAnything achieves the highest overall accuracy (63.4%), with notable best scores in several domains and types, especially in Finance and Multimodal queries. MMGraphRAG follows closely, excelling in Academic and Government domains as well as Unanswerable queries. LightRAG's strongest point is in Text-only queries, whereas GPT-4o-mini records the lowest overall performance among the four methods.", 'meta_data': {'page_no.': 7, 'index_on_page': 2, 'content_type': 'table', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}}]

sample_textual_chunks_insertion_payloads = {'page_no.': 0, 'index_on_page': 1, 'raw_content': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK', 'content_type': 'title', 'doc_id': '12e54263-17eb-4436-97cc-c15b81a2fb21', 'chunk_id': '12e54263-chunk-1', 'document_title': 'RAG-ANYTHING: ALL-IN-ONE RAG FRAMEWORK'}                                 
